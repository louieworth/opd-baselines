# Adapted from meituan-longcat/AMO-Bench (MIT), parser-only evaluation.
# Upstream revision: 52e1f378e4bcb0c593e860be38f9251b1a192571.
# See third_party/amo_bench/LICENSE.
...
def verify_variable_answer(pred_extract: str, answer: str, try_list: list[str]) -> bool:
    ...
    if not pred_parse_ori or not try_list:
        return False
